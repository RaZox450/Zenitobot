...
if __name__ == "__main__":
    ...
    logger = wandb.init(name="Zenitobot-v3", project="Zenitobot", entity="rolv-arild", id=run_id, config=config)
    ...
    rollout_gen = RedisRolloutGenerator("tecko",
                                        redis,
                                        lambda: ZenitobotObsBuilder(None, 6),
                                        lambda: ZenitobotRewardFunction(),
                                        ZenitobotAction,
    ...
    if run_id is not None:
        alg.load("ppos/Zenitobot_1660212070.3225243/Zenitobot_12300/checkpoint.pt")
